...
" style="margin-bottom: 5px;">
    ...
    <input disabled class="form-control" value="<?= $sendmailfrom ?>" placeholder="abc@domain.com" />
</label>
<label class="block text-sm" style="margin-bottom: 5px;">
    <span class="text-gray-700 dark:text-gray-400">Subject:</span>
    <input disabled style="border: none !important;" class="form-control" value="<?= $rowmail['subject'] ?>" placeholder="Message Subject" />
</label>
<div> <label class="block text-sm" style="margin-bottom: 5px;">
    ...
    <!-- <textarea class="form-control" placeholder="Client's Name" id="" name="w3review" rows="8" cols="50"></textarea> -->
...
<div>
    <button onclick='redir("<?= $rowmail["senderid"] ?>","","composemail","_blank")' id="modalsubmit" class="w-full px-3 py-1 mt-6 text-sm font-medium d-none">
        Submit
    </button>
    <div id='redirect'></div>
</div>
