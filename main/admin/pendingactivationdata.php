...
while ($row = $obj->fetch_assoc($result)) {
    ...
    if (in_array(37, $permissions)) {
        ...
        <div class='dropdown-menu dropdown-menu-end'>
          <a class='dropdown-item' onclick='fun1(\"" . $row['id'] . " \", \"approveactivation\", \"resultid\",\"Approve\")'>
            Approve
          </a>
          <a class='dropdown-item' onclick='fun1(\"" . $row['id'] . " \", \"approveactivation\", \"resultid\",\"Reject\")'>
            Disapprove
          </a>
        </div>
      </div>";
