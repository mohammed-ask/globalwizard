...
while ($row = $obj->fetch_assoc($result)) {
    ...
    $n[] =  $row['subject'];
    $n[] =  "<button class='btn' aria-label='view' data-bs-toggle='modal' data-bs-target='#modal-report'  onclick='dynamicmodal(\"" . $row['id'] . "\", \"viewmaildetail\", \"sentmail\", \"View Mail\")'> View Msg
