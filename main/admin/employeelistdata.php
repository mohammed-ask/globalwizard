...
while ($row = $obj->fetch_assoc($result)) {
    ...
    if (in_array(41, $permissions)) {
        $n[] = '<label class="form-check form-switch" style="margin-top: 6px;">
    ...
    if (in_array(11, $permissions)) {
        $a .= "<button class='btn' style='margin-right:10px;' onclick='del(\"" . $row['id'] . "\", \"deleteuser\", \"Delete User \")' aria-label='Delete'>
             <svg class='w-4 h-4' aria-hidden='true' fill='currentColor' viewBox='0 0 20 20'>
