...
<div class="page-body">
    <div class="container-xl">
        <div class="flex items-center justify-between">
            <h3 class="my-2 font-semibold text-gray-700 dark:text-gray-200">Employee Details</h3>
            <?php if (in_array(9, $permissions)) { ?>
                <button data-bs-toggle="modal" data-bs-target="#modal-report" onclick='dynamicmodal("none", "addemployee", "", "Add Employee")' class="my-2 px-3 py-1 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-purple-600 border border-transparent rounded-lg active:bg-purple-600 hover:bg-purple-700 focus:outline-none focus:shadow-outline-purple">
                    + Add Employee
                </button>
            <?php } ?>
        </div>
